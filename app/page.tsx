    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-rose-50">
      ...
      <section id="vision" className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-3xl font-bold text-gray-800 mb-6">The Problem We're Solving</h3>
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">Women often feel unsafe walking alone, especially at night</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">Existing safety apps are clunky and not user-friendly</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">Lack of real-time communication with trusted contacts</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-red-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">No seamless integration between safety and daily life</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <p className="text-gray-600">Intuitive, beautiful interface that feels natural to use</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-green-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">One-tap emergency alerts with instant location sharing</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-green-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">Smart safety network with trusted friends and family</p>
              </div>
              <div className="flex items-start space-x-4">
                <div className="w-6 h-6 bg-green-500 rounded-full flex-shrink-0 mt-1"></div>
                <p className="text-gray-600">Seamless integration with daily routines and activities</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="container mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Smart Location Sharing</h3>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Emergency SOS</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Safety Network</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Safe Routes</h3>
            <p className="text-gray-600">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
            ...
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Community Alerts</h3>
            <p className="text-gray-600">
