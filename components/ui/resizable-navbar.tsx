...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "absolute inset-0 hidden flex-1 flex-row items-center justify-center space-x-2 text-sm font-medium text-white transition duration-200 hover:text-yellow-400 lg:flex lg:space-x-2",
        className,
      )}
    >
      {items.map((item, idx) => (
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary: "border-2 border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-black transition-all duration-300 lg:bg-transparent lg:text-white",
